...
<body onload="updateTotal()">
    ...
    <div class="product-grid">
        ...
        <form action="payment.php" method="POST" id="cart-form">
            ...
            <button type="submit" onclick="submitSelectedItems()" style="background: green; color: white; padding: 10px; margin-top: 10px; border: none; cursor: pointer;">
                Mua hàng
            </button>
        </form>
    </div>
    ...
    <script>
        ...
        function submitSelectedItems() {
            ...
            document.querySelectorAll(".cart-item").forEach(row => {
                ...
                let productName = productCell.textContent.split('\n').pop().trim();
                selectedItems.push({
                    id: productId,
                    quantity: quantity,
                    price: price,
